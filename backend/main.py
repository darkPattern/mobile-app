...
def extract_text():
    ...
    try:
        if file and allowed_file(file.filename):
            medicine_keywords = ["tablet", "syrup", "liquid", "Day", "day", "Tablet", "TABLET", "DAY"]
...
def process_image():
    ...
    URL = "http://4b10-34-86-217-242.ngrok.io/extract_text"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({'error': 'Something went wrong in the external API'}), 500
